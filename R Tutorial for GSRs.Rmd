...
csv <- read.csv(file = "CDE_Graduation_Counts.csv") #RC: Since I've chosen a .csv data file to load in, I'm going ahead and loading it so I can play with it in the analysis section
...
```{r Academic Year}
unique(csv$Academic.Year) #the unique() function shows the unique values for an object
```
...
csv=csv %>%
  ...
  relocate(Year,1) #mutate adds columns to the end of the dataframe, so I'm
