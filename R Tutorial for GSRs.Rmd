...
alameda=cde_grad_counts %>%
  ...
  mutate(OUSD=ifelse(District.Name=="Oakland Unified",1,0),  #create a variable indexing OUSD or not
...
```
Looks like the implementation of Measurey Y didn't noticeably change anything in
